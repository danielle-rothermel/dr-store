...
FUNCTIONAL_MODULES = (
    ...
    "dr_store.artifact_bundle._layering",
    ...
    "dr_store.core.reasons",
    "dr_store.core.store_errors",
    "dr_store.core.directory_errors",
    "dr_store.core.verified_read_errors",
    ...
    "dr_store.lease.models",
    "dr_store.localfs",
    "dr_store.localfs._fs",
    "dr_store.localfs.errors",
    "dr_store.object_store",
    "dr_store.record_cache",
    "dr_store.record_cache.cache",
    "dr_store.record_cache.sqlite",
    "dr_store.relational",
    "dr_store.relational._helpers",
    "dr_store.relational.errors",
    "dr_store.relational.observer",
    "dr_store.relational.postgres",
    "dr_store.relational.sqlite",
    ...
    "dr_store.storage_backends.postgresql_schema",
    "dr_store.storage_backends.sqlite",
    "dr_store.sync",
    "dr_store.sync.blocking",
    "dr_store.testing",
)
